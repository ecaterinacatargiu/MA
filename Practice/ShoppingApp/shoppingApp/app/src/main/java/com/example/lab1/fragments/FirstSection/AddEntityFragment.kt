...
class AddEntityFragment : Fragment() {
    ...
    private fun add() {
        ...
        var quantity = attr2.text.toString()
        var price = attr3.text.toString()
        var status = attr4.text.toString()


        val entity = Entity(Random.nextInt(), name, Integer.parseInt(quantity.toString()),Integer.parseInt(price.toString()), status.toString())
        ...
        else
        {
            ...
            {
                val entityBackup = EntityBackup(0, name, Integer.parseInt(quantity.toString()), Integer.parseInt(price.toString()), status.toString())
