...
class SectionsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.toTeacherButton.setOnClickListener{
            findNavController().navigate(R.id.action_sectionsFragment_to_teacherSectionFragment)
        }

        if(isNetworkAvailable(context) == true)
        {
            view.toStudentsButon.setOnClickListener{
                findNavController().navigate(R.id.action_sectionsFragment_to_studentsSectionFragment)
            }
        }
        else
        {
        ...
        if(isNetworkAvailable(context) == true)
        {
            view.toStatisticsButton.setOnClickListener{
                findNavController().navigate(R.id.action_sectionsFragment_to_statisticsSectionFragment)
            }
        }
        else
        {
